...
class Logo extends \Magento\Framework\View\Element\Template
{
    ...
    public function __construct(
        ...
        \Magento\MediaStorage\Helper\File\Storage\Database $fileStorageHelper = null,
        array $data = []
    ) {
    ...
    {
        if ($this->_fileStorageHelper && $this->_fileStorageHelper->checkDbUsage() && !$this->getMediaDirectory()->isFile($filename)) {
