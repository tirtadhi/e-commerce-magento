    ...
    ResetAfterRequestInterface
{
    ...
    public function __construct(
        ...
        \Magento\MediaStorage\Helper\File\Storage\Database $coreFileStorageDatabase = null,
    ...
    {
        $isDbStorageUsed = $this->_coreFileStorageDatabase
            && $this->_coreFileStorageDatabase->checkDbUsage();

        if (!$this->getConfig(self::XML_PATH_USE_REWRITES) && $isDbStorageUsed) {
