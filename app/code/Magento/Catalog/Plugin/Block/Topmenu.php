...
class Topmenu
{
    ...
    protected function getCategoryTree($storeId, $rootId)
    {
        ...
        try {
            ...
            // Use direct condition for static column to avoid EAV attribute validation issues.
            $collection->getSelect()->where('e.path LIKE ?', '1/' . $rootId . '/%'); //load only from store root
            ...
            // Keep storefront renderable even when category EAV metadata is incomplete.
