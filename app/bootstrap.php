...
// Compatibility shim for installations using elasticsearch/elasticsearch v8 namespace.
if (!class_exists('Elasticsearch\\ClientBuilder') && class_exists('Elastic\\Elasticsearch\\ClientBuilder')) {
    class_alias('Elastic\\Elasticsearch\\ClientBuilder', 'Elasticsearch\\ClientBuilder');
}
if (!class_exists('Elasticsearch\\Client') && class_exists('Elastic\\Elasticsearch\\Client')) {
